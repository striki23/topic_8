...
while True:
    ...
    if step_p_1 not in play and step_p_2 not in play:
        print(WARNING, 'Пожалуйста', hints)
    elif step_p_1 not in play:
        print(WARNING, player_1, hints)
    elif step_p_2 not in play:
        print(WARNING, player_2, hints)
    # если все игроки верно сделали свой ход, проверяем кто выиграл
        ...
        if step_p_1 == step_p_2:
            ...
            if (
                (step_p_1 == 'камень' and step_p_2 == 'ножницы')
...
# 1. Нет пустой строки до каждого раунда
# 2. Не хватает пробел после имени игрока
